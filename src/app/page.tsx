...
export default function Home() {
  ...
  return (
    <div className="relative flex h-screen w-screen items-center justify-center bg-zinc-300">
      <div>
        <div className="mb-10 rounded bg-gray-400 p-3">
          ...
          <div className="mt-4 flex w-full justify-around">
            <a
              ...
              href="https://www.instagram.com/p/C8Hrm2spgRm/"
            >
              Sim
            </a>
            <button
      ...
      <div className="fixed bottom-0">Desenvolvido por Higor Matheus</div>
    </div>
  );
  // return (
  //   <>
