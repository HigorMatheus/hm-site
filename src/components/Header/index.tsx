...
export const Header: React.FC = () => {
  return (
    <header className="flex items-center justify-center h-20 px-6 py-4 bg-zinc-800">
      <div className="flex items-center w-full h-16 max-w-screen-2xl">
        {/* <Image src={SwintLogoSvg} alt="SwintLogo" className="h-10 w-11" /> */}
        <div className="flex items-center gap-2 ml-6 mr-auto">
          {/* <Breadcrumbs /> */}
        </div>
        <div className="relative flex items-center justify-center gap-4 ">
          <div className="flex items-center gap-4">
            ...
            >
              <button type="button">
                {/* <img
                  src={`https://ui-avatars.com/api/?name=${encodeURIComponent(
                    data?.name ?? '',
                  )}&color=${withoutHashtag(
                    THEME.beta.colors.primary,
                  )}&background=${withoutHashtag(
                    lighten(0.35, THEME.beta.colors.primary),
                  )}&uppercase=true&bold=true`}
                  alt={`Foto de perfil do usuário ${data?.name}`}
              ...
              <div
                ...
                className={classNames(
                  'absolute z-50 flex-col bg-white min-w-[160px] shadow transition-all',
                  'items-center justify-center rounded-md right-0 mt-4',
                  {
                    // 'flex opacity-100 transition-all': !show,
                    // 'hidden opacity-0 transition-all': !show,
                  },
                )}
              >
                {/* <Button
            ...
            <div>
              <p className={classNames('font-light text-white')}>
                Olá, Higor Matheus!
              </p>
              <div>
                <div className="font-light text-white">Operador</div>
              </div>
            </div>
          </div>
        </div>
    ...
    //   <header className="flex items-center justify-center w-screen h-20 mt-12">
    //     <svg
